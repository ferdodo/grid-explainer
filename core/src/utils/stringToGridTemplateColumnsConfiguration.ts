...
/**
 * Converts a string to GridTemplateColumnsConfiguration
 */
export function stringToGridTemplateColumnsConfiguration(
	value: string | undefined,
): GridTemplateColumnsConfiguration | undefined {
	if (!value || !value.trim()) {
		return undefined;
	}
